...
export default function AutomationPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div>
        <h1 className="admin-title">Background Data Configuration</h1>
        <p className="admin-subtitle mt-2">
          Configure your brand information and automation parameters for content generation.
        </p>
      </div>
        ...
        <TabsContent value="product" className="space-y-6">
          <Card className="bg-gradient-card shadow-md hover:shadow-lg transition-all duration-300">
            <CardHeader className="border-b border-card-border bg-gradient-to-r from-primary/5 to-primary/10">
              ...
              <CardDescription className="admin-card-description">
                Optional product parameters for content recommendations
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    id="product_name"
                    placeholder="Full product name for recommendations"
                    value={formData.product_name}
                    onChange={(e) => handleInputChange('product_name', e.target.value)}
                    className="admin-body-text"
                  />
                  <p className="admin-stats-label">Complete product name for content recommendations</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="admin-stats-label">Classification of offering type</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="admin-body-text"
                  />
                  <p className="admin-stats-label">Direct link to product page (optional)</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={formData.product_detail_level} onValueChange={(value) => handleInputChange('product_detail_level', value)}>
                    ...
                    <SelectContent>
                      <SelectItem value="brief">Brief mention</SelectItem>
                      <SelectItem value="medium">Medium detail</SelectItem>
                      <SelectItem value="detailed">Detailed recommendation</SelectItem>
                    </SelectContent>
                  </Select>
                  <p className="admin-stats-label">Level of product recommendation detail (when product is specified)</p>
                </div>
              </div>

              <div className="space-y-2">
                <Label htmlFor="product_specific" className="admin-label">
                  Product-Specific Requirements <Badge variant="outline" className="ml-2">{`{{product_specific}}`}</Badge>
                </Label>
                <Textarea
                  id="product_specific"
