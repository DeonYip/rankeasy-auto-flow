...
export function UserSidebar() {
  ...
  return (
    <div className="fixed inset-y-0 left-0 z-50 w-80 bg-sidebar-background border-r border-sidebar-border lg:block hidden">
      {/* Logo */}
      <div className="flex h-16 items-center px-6 border-b border-sidebar-border">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="admin-body-text text-sidebar-foreground/70">Premium Panel</p>
          </div>
        </div>
      </div>
        ...
        <div className="px-6 py-4 border-b border-sidebar-border">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="admin-body-text text-sidebar-foreground/70 truncate">
                {user.email}
              </p>
            </div>
          </div>
          <div className="mt-3 flex items-center space-x-2">
            ...
            <span className="admin-body-text text-sidebar-foreground">
